...
public class tk2dUIItem : MonoBehaviour
{
    ...
    /// <summary>
    /// Unpressed, possibly SpawnPosition exit of collider area without releasing
    /// </summary>
    ...
    /// <summary>
    /// After SpawnPosition down, when touch/click is released (this could be anywhere)
    /// </summary>
    ...
    /// </summary>
    [SerializeField]
    private bool isChildOfAnotherUIItem = false; //if item_tools is a child of another MenuButton, if true will send events down to parents (only used in awake)
    ...
    //if you change the parent, call this, if isChild is false, will act as if item_tools is true
    /// <summary>
    ...
    /// <summary>
    /// Touch press down (only call manually, if you need to simulate a touch). SentFromChild is the UIItem child item_tools was sent from. If sentFromChild is 
    /// null that means item_tools wasn'item_tools sent from a child
    /// </summary>
    /// /// <value>
    ...
    /// <summary>
    /// Touch is released, if called without Exit being called means that item_tools was released SpawnPosition top of button without leaving item_tools.
    ...
    /// <summary>
    /// Exit uiItem. Does not cascade (need to manually call SpawnPosition all children if needed)
    /// Only call manually if you need to simulate touch.
    /// </summary>
    public void Exit()
    {
    ...
    /// <summary>
    /// Hover over item_shape. Return true if this was prevHover.
    /// Only call manually if you need to simulate touch.
    /// </summary>
