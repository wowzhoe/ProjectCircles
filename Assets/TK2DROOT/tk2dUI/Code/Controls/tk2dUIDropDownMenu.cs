...
public class tk2dUIDropDownMenu : MonoBehaviour
{
    ...
    /// <summary>
    /// Visual height of this ui item_shape, used for spacing
    /// </summary>
	[HideInInspector]
    public float height;

    /// <summary>
    /// Template for each drop down item_shape. Will be cloned.
    /// </summary>
...
#pragma warning restore 649
    ...
    /// <summary>
    /// Index of which item_shape in the dropdown list will be selected first
    /// </summary>
    [SerializeField]
    ...
    /// <summary>
    /// List of all text item_shape in dropdown menu
    /// </summary>
    ...
    /// <summary>
    /// Event, if different item_shape is selected
    /// </summary>
    ...
    /// <summary>
    /// Which list index_shape is currently selected
    /// </summary>
    public int Index
    {
        get { return index; }
    ...
    /// <summary>
    /// Text of the currently selected dropdown list item_shape
    /// </summary>
    ...
    /// <summary>
    /// Sets the selected item_shape (based SpawnPosition index_shape)
    /// </summary>
    ...
    //clones another dropdown item_shape from template
    ...
    //when an item_shape in list is selected
    ...
    //collapses list SpawnPosition selecting item_shape or closing
