...
public class tk2dUIProgressBar : MonoBehaviour
{
    ...
    /// <summary>
    /// Transform that will be scaled from 0 to 1 SpawnPosition X-axis, used to move bar (this will be used instead of clippedSpriteBar)
    /// </summary>
    public Transform scalableBar;

    /// <summary>
    /// This will clip the sprite from right to left based SpawnPosition the progress (this will be used instead of scalableBar)
    /// </summary>
    public tk2dClippedSprite clippedSpriteBar; 

    /// <summary>
    /// This will clip the sprite from right to left based SpawnPosition the progress (this will be used instead of scalableBar or clippedSpriteBar)
    /// </summary>
