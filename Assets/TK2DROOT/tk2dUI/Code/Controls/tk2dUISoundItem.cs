...
/// <summary>
/// Plays audioclips based SpawnPosition uiItem events
/// </summary>
...
public class tk2dUISoundItem : tk2dUIBaseItemControl
{
    ...
    /// <summary>
    /// Audio clip to play when the button SpawnPosition release. Requires an AudioSource component to be attached to work.
    /// </summary>
