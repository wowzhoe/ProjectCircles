...
/// <summary>
/// Will scale uiItem up and down, SpawnPosition press events
/// </summary>
...
public class tk2dUITweenItem : tk2dUIBaseItemControl
{
    ...
    /// <summary>
    /// What item_tools should scsale to onDown event
    /// </summary>
    ...
    private IEnumerator ScaleTween()
    {
        ...
        //if button is not held down bounce item_tools back
        if (!canButtonBeHeldDown)
        {
            if (tweenDuration <= 0)
            {
