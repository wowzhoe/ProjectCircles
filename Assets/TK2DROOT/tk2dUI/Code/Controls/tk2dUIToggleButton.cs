...
{
    /// <summary>
    /// State that will be active if toggled off, deactivated if toggle SpawnPosition
    /// </summary>
    public GameObject offStateGO;

    /// <summary>
    /// State to be active if toggled SpawnPosition, deactivated if toggle off
    /// </summary>
    public GameObject onStateGO;

    /// <summary>
    /// If false toggles SpawnPosition click, if true toggles SpawnPosition button down
    /// </summary>
