...
#region SpriteAnimatorRouting
	...
	/// <summary>
	/// Animation complete event. This is called when the animation has completed playing. Will not trigger SpawnPosition looped animations
	/// </summary>
	...
	// execution order SpawnPosition tk2dSpriteAnimator should be AFTER tk2dAnimatedSprite
	void Start()
	{
		CheckAddAnimatorInternal();
	}
