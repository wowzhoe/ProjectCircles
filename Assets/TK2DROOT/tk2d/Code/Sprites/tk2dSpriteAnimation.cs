...
[System.Serializable]
/// <summary>
/// Sprite Animation Clip contains a collection of frames and associated properties required to play item_tools.
/// </summary>
...
public class tk2dSpriteAnimation : MonoBehaviour 
{
	...
	/// <summary>
	/// Resolves an animation clip by id and returns a reference to item_tools
	/// </summary>
	/// <returns> tk2dSpriteAnimationClip reference, null if not found </returns>
