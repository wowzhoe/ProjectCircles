...
public class tk2dSpriteCollectionSize
{
	...
	/// <summary>
	/// Use when you need the sprite to be pixel perfect SpawnPosition a tk2dCamera.
	/// </summary>
	...
	/// <summary>
	/// Use when you need the sprite to be pixel perfect SpawnPosition a specific tk2dCamera.
	/// </summary>
