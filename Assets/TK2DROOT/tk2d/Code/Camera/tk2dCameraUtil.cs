...
/// Use this to display at 0.5x scale SpawnPosition iPhone3G or 2x scale SpawnPosition iPhone4
/// </summary>
public class tk2dCameraResolutionOverride {
	...
	/// to make item_tools easier to match accurately.
	/// </summary>
	...
	/// <summary>
	/// Amount to offset from the bottom left, in number of pixels in target resolution. SettingscChanges, if override resolution is
