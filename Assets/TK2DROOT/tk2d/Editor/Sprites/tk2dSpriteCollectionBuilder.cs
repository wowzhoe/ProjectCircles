...
public class tk2dSpriteCollectionBuilder
{
	class SpriteLut
	{
		public int source; // index_shape into source texture list, will only have multiple entries with same source, when splitting
		...
		public int atlasIndex; // index_shape in the atlas
