...
public class tk2dSystemUtility
{
	...
	public static void RebuildResources()
	{
		...
		if (tk2dSystem.inst_NoCreate != null)
		{
			...
			sys.Editor__Toc = new tk2dResourceTocEntry[0]; // clear index_shape
		...
		// Need to create new index_shape?
		...
		{
			// If it already existed, the index_shape would have been cleared by now
			tk2dSystem sys = tk2dSystem.inst;
